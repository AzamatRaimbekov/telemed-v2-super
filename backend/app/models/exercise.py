...
class Exercise(TenantMixin, Base):
    ...
    target_joints: Mapped[Optional[dict]] = mapped_column(JSON)
    angle_thresholds: Mapped[Optional[dict]] = mapped_column(JSON)
    demo_video_url: Mapped[Optional[str]] = mapped_column(String(500))
    instructions: Mapped[Optional[str]] = mapped_column(Text)
    default_sets: Mapped[Optional[int]] = mapped_column(Integer)
    default_reps: Mapped[Optional[int]] = mapped_column(Integer)
...
class ExerciseSession(TenantMixin, Base):
    ...
    treatment_plan_item_id: Mapped[Optional[uuid.UUID]] = mapped_column(UUID(as_uuid=True), ForeignKey("treatment_plan_items.id"), nullable=True)
    ...
    accuracy_score: Mapped[Optional[float]] = mapped_column(Numeric(5, 2))
...
class ExerciseRep(TenantMixin, Base):
    ...
    max_angle: Mapped[Optional[float]] = mapped_column(Numeric(6, 2))
    min_angle: Mapped[Optional[float]] = mapped_column(Numeric(6, 2))
    duration_ms: Mapped[Optional[int]] = mapped_column(Integer)
    form_score: Mapped[Optional[float]] = mapped_column(Numeric(5, 2))
    feedback: Mapped[Optional[dict]] = mapped_column(JSON)
