...
from app.api.v1.routes import auth, clinics, health, users, portal, portal_voice, patients, registration, staff, medical_history, rooms, ai, treatment, stroke, settings, recovery, diagnoses, icd10, audit, schedule, notifications, analytics, telemedicine, patient_ai, pharmacy, billing, laboratory, monitoring, infrastructure, qr, chief_dashboard, queue, notification_logs, telegram_bot, export, document_templates
